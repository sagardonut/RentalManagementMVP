...
export default function SuperAdminSignIn() {
  ...
  useEffect(() => {
    if (user && (user.role === 'superadmin' || user.role === 'admin')) navigate('/admin/super');
  }, [user, navigate]);
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-surface-container-lowest rounded-2xl shadow-[0_24px_64px_rgba(0,64,161,0.08)] border border-outline-variant/20 overflow-hidden">
            ...
            <div className="bg-primary px-8 pt-8 pb-6">
              ...
              <p className="text-on-primary/60 text-sm mt-2 font-medium">Sign in to access platform-wide management</p>
            </div>
            ...
            <div className="px-8 py-8">
              ...
              <p className="text-center text-sm text-on-surface-variant mt-6">
                <Link to="/login" className="text-primary font-bold hover:underline">Back to Entry Points</Link>
              </p>
            </div>
          </div>
        </div>
