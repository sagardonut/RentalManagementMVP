...
export default function SignUp() {
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col pt-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-on-surface">Partner with us.</h1>
              <p className="text-on-surface-variant text-lg max-w-xl">Complete your professional profile to start listing exclusive Kathmandu properties on Nepal's premier sanctuary.</p>
            </div>
            ...
            <div className="bg-surface-container-lowest p-8 md:p-10 rounded-xl shadow-[0_8px_24px_-8px_rgba(25,27,35,0.06)] border border-outline-variant/20">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      required
                      className={`w-full px-4 py-3 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-surface-tint/20 transition-all text-on-surface ${fieldErrors.fullName ? 'ring-2 ring-error' : ''}`} 
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      required
                      className={`w-full px-4 py-3 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-surface-tint/20 transition-all text-on-surface ${fieldErrors.phone ? 'ring-2 ring-error' : ''}`} 
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    onChange={handleChange}
                    required
                    className={`w-full px-4 py-3 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-surface-tint/20 transition-all text-on-surface ${fieldErrors.email ? 'ring-2 ring-error' : ''}`} 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      required
                      className={`w-full px-4 py-3 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-surface-tint/20 transition-all text-on-surface ${fieldErrors.password ? 'ring-2 ring-error' : ''}`} 
                      placeholder="••••••••" 
                      type="password"
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      onChange={handleChange}
                      required
                      className={`w-full px-4 py-3 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-surface-tint/20 transition-all text-on-surface ${fieldErrors.confirmPassword ? 'ring-2 ring-error' : ''}`} 
                      placeholder="••••••••" 
                      type="password"
                      autoComplete="new-password"
                    />
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <span className="text-sm text-on-surface-variant leading-relaxed">I agree to the <a className="text-primary underline" href="#">Partner Terms of Service</a> and confirm that I am a licensed real estate professional in Nepal.</span>
                </div>
            ...
            <div className="bg-surface-container-low rounded-xl overflow-hidden shadow-sm border border-outline-variant/10">
              <div className="relative h-48 w-full">
                ...
                <div className="absolute bottom-6 left-8">
                  ...
                  <h2 className="text-2xl font-extrabold text-on-surface">Platform Access</h2>
                </div>
              </div>
              <div className="p-8 space-y-8">
                <div className="flex justify-between items-end">
                  <div className="space-y-1">
                    <p className="text-sm text-on-surface-variant font-medium">One-time Access Fee</p>
                    <p className="text-xs text-primary font-bold">Lifetime listing privileges</p>
                  </div>
                  <div className="text-right">
                    <p className="text-4xl font-black text-on-surface">Rs. 500</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Select Payment Method</label>
                  <div className="grid grid-cols-2 gap-4">
                    <button 
                      type="button"
                      onClick={() => setPaymentMethod('esewa')}
                      className={`group flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${paymentMethod === 'esewa' ? 'bg-surface-container-lowest border-primary shadow-sm' : 'bg-surface-container-low border-transparent hover:border-outline-variant'}`}
                    >
                      ...
                      <span className={`text-xs font-bold ${paymentMethod === 'esewa' ? 'text-on-surface' : 'text-on-surface-variant'}`}>eSewa Wallet</span>
                    ...
                    <button 
                      ...
                      className={`group flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${paymentMethod === 'khalti' ? 'bg-surface-container-lowest border-primary shadow-sm' : 'bg-surface-container-low border-transparent hover:border-outline-variant'}`}
                    >
                      ...
                      <span className={`text-xs font-bold ${paymentMethod === 'khalti' ? 'text-on-surface' : 'text-on-surface-variant'}`}>Khalti SDK</span>
                ...
                <div className="space-y-4 pt-4">
                  <button 
                    ...
                    disabled={isLoading}
                    className="w-full bg-primary hover:bg-surface-tint text-white py-5 rounded-xl font-bold text-lg shadow-lg shadow-primary/20 transition-all active:scale-[0.98] disabled:opacity-50"
                  >
                    {isLoading ? 'Creating Account...' : 'Create Account'}
                  </button>
                  <p className="text-center text-xs text-on-surface-variant lowercase">
      ...
      <footer className="bg-surface-container py-10 px-12 border-t border-outline-variant/10">
        <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-bold uppercase tracking-widest text-on-surface-variant">
