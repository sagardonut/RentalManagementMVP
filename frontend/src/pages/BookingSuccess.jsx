    ...
    <div className="bg-[#FAFBFE] min-h-screen font-['Inter']">
      ...
      <main className="max-w-screen-xl mx-auto px-6 pt-32 pb-20 flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-10 mb-16">
            ...
            <div className="lg:col-span-7 bg-white rounded-[32px] p-4 border border-slate-100 shadow-[0_12px_40px_rgba(0,0,0,0.03)] overflow-hidden">
                <div className="relative aspect-[16/10] rounded-[24px] overflow-hidden mb-8">
                    ...
                    />
                    <div className="absolute top-4 left-4 inline-flex px-4 py-2 bg-white/90 backdrop-blur-md rounded-full items-center gap-2 border border-white/20 shadow-sm">
                ...
                <div className="px-6 pb-6">
                    ...
                    <h2 className="text-[32px] font-black text-slate-900 mb-2 tracking-tight leading-tight">{room.title}</h2>
            ...
            <div className="lg:col-span-5 space-y-8">
                ...
                <div className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-[0_12px_40px_rgba(0,0,0,0.03)]">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <div className="text-[17px] font-black text-slate-900 mb-0.5">Rajesh Shakya</div>
                            <div className="text-[12px] text-slate-400 font-semibold">Senior Portfolio Manager</div>
                        </div>
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 h-12 bg-[#F1F5F9] hover:bg-[#E2E8F0] transition-colors rounded-xl text-slate-900 text-xs font-bold">
                ...
                {/* Stay Summary Card */}
                <div className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-[0_12px_40px_rgba(0,0,0,0.03)] border-l-4 border-l-[#0040A1]">
                    <h3 className="text-[11px] font-black tracking-[0.15em] text-slate-400 uppercase mb-6">STAY SUMMARY</h3>
                    
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            <span className="text-[13px] font-semibold text-slate-500">Check-in</span>
                            <span className="text-[13px] font-bold text-slate-900">{new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-[13px] font-semibold text-slate-500">Guests</span>
                            <span className="text-[13px] font-bold text-slate-900">2 Adults</span>
                        </div>
