...
export default function AgentSignUp() {
  ...
  const inputClass = "w-full px-4 py-3 bg-surface dark:bg-slate-800 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary text-on-surface dark:text-slate-100 font-medium transition-all";
  const labelClass = "text-[0.7rem] font-black uppercase tracking-widest text-on-surface dark:text-slate-400";
            ...
            <div className="px-8 py-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-start gap-3 pt-1">
                  ...
                  <span className="text-sm text-on-surface dark:text-slate-400">I confirm I am a licensed real estate professional and agree to the <a href="#" className="text-primary underline">Agent Terms</a>.</span>
                </div>
