...
const SuperAdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#FDFDFF] dark:bg-slate-900">
      {/* Sidebar - Fixed width */}
      ...
      <div className="flex-1 ml-80 min-h-screen flex flex-col">
        ...
        <main className="p-10 space-y-10">
          {/* Dashboard Header */}
          <div>
            <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">Main Dashboard</h1>
