  ...
  return (
    <div className="bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100 min-h-screen flex">
      ...
      <aside className="h-screen w-64 fixed left-0 top-0 z-40 flex flex-col border-r border-slate-200 dark:border-slate-800 p-4 gap-2 bg-slate-50 dark:bg-slate-950">
        ...
        <nav className="flex-1 flex flex-col gap-1">
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all hover:translate-x-1 duration-200 ${activeTab === 'bookings' ? 'text-blue-700 bg-blue-50' : 'text-slate-500 dark:text-slate-400 hover:text-blue-600 hover:bg-slate-100 dark:bg-slate-800'}`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all hover:translate-x-1 duration-200 ${activeTab === 'agents' ? 'text-blue-700 bg-blue-50' : 'text-slate-500 dark:text-slate-400 hover:text-blue-600 hover:bg-slate-100 dark:bg-slate-800'}`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all hover:translate-x-1 duration-200 ${activeTab === 'rooms' ? 'text-blue-700 bg-blue-50' : 'text-slate-500 dark:text-slate-400 hover:text-blue-600 hover:bg-slate-100 dark:bg-slate-800'}`}
          >
        ...
        <div className="mt-auto border-t border-slate-200 dark:border-slate-800 pt-4 flex flex-col gap-1">
          <a className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-blue-600 hover:bg-slate-100 dark:bg-slate-800 rounded-xl transition-all hover:translate-x-1 duration-200" href="#">
            <span className="material-symbols-outlined">settings</span>
            <span className="text-sm font-medium">Settings</span>
          </a>
          <button
            onClick={handleLogout}
            className="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-blue-600 hover:bg-slate-100 dark:bg-slate-800 rounded-xl transition-all hover:translate-x-1 duration-200 w-full"
          >
      ...
      <main className="ml-64 flex-1 overflow-y-auto min-h-screen">
        <header className="w-full sticky top-0 z-50 flex justify-between items-center px-10 py-4 border-b border-slate-200 dark:border-slate-700/50 dark:border-slate-700/50 bg-white dark:bg-slate-900/80 dark:bg-slate-900/80 backdrop-blur-lg shadow-sm">
        ...
        <div className="p-10 max-w-7xl mx-auto space-y-16">
            ...
            <section>
              <div className="flex justify-between items-end mb-8">
                <div>
                  ...
                  <h3 className="text-3xl font-bold tracking-tight text-on-surface dark:text-slate-100">Booked Properties</h3>
                </div>
              </div>
              {loading ? (
                ...
                <div className="text-center py-16 bg-surface dark:bg-slate-800 rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {bookings.map(booking => (
                    <div key={booking._id} className="bg-surface dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm border border-outline-variant/20">
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-sm text-on-surface dark:text-slate-400 mb-3 flex items-center gap-1">
                        ...
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span className="text-on-surface dark:text-slate-400">{booking.numRooms || 1} room(s)</span>
                        </div>
            ...
            <section>
              <div className="flex justify-between items-end mb-8">
                <div>
                  ...
                  <h3 className="text-3xl font-bold tracking-tight text-on-surface dark:text-slate-100">Curated Real Estate Professionals</h3>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {agents.map(agent => (
                ...
                <div className="bg-primary text-on-primary rounded-xl p-6 shadow-xl relative overflow-hidden flex flex-col justify-center">
                  <div className="absolute -right-8 -top-8 w-32 h-32 bg-white dark:bg-slate-900/10 rounded-full blur-2xl"></div>
          ...
          {activeTab === 'rooms' && (
            <section className="bg-surface dark:bg-slate-800 rounded-3xl p-8 lg:p-12">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-12">
                <div className="max-w-md">
                  <h3 className="text-3xl font-black tracking-tight text-on-surface dark:text-slate-100 mb-2">Rooms Explorer</h3>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="bg-surface dark:bg-slate-800 border border-outline-variant/30 rounded-full px-4 py-2 flex items-center gap-2 shadow-sm">
