        ...
        <section className="py-24 px-8 max-w-screen-2xl mx-auto">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <p className="text-on-surface-variant max-w-md">Curated listings featuring modern amenities and traditional Kathmandu charm.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-[700px]">
              ...
              <Link to="/rooms?location=Jhamsikhel" className="md:col-span-2 md:row-span-2 relative rounded-xl overflow-hidden group cursor-pointer shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 p-8">
                  ...
                  <button className="mt-4 px-6 py-2 bg-white text-slate-900 font-bold rounded-full text-xs uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">Explore Area</button>
                </div>
              </Link>
