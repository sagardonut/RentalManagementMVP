      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center bg-surface pt-24">
          <div className="text-center">
            ...
            <p className="text-slate-500 mb-8">The room you are looking for doesn't exist.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-on-surface mb-2">{room.title}</h1>
              <div className="flex items-center gap-4 text-on-surface-variant">
                <p className="text-2xl font-semibold text-primary">{formattedPrice}<span className="text-sm font-normal text-on-surface-variant">/mo</span></p>
            ...
            <div className="bg-surface-container-low p-8 rounded-xl space-y-6">
              <h2 className="text-lg font-bold tracking-tight uppercase text-on-surface-variant">Amenities & Features</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl shadow-lg shadow-on-surface/5 border border-outline-variant/20">
                ...
                {!user ? (
                  /* Guest View */
                  <div className="relative bg-surface-container-high rounded-xl p-6 overflow-hidden text-center">
                    <div className="absolute inset-0 backdrop-blur-md bg-surface-container-high/40 z-10"></div>
                    <div className="relative z-20 flex flex-col items-center gap-4">
                      <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center mb-1">
                        <span className="material-symbols-outlined text-primary">lock</span>
                      </div>
                      <h5 className="font-bold text-on-surface uppercase tracking-widest text-[10px]">Locked Access</h5>
                      <div className="space-y-1 select-none">
                        <p className="text-sm font-mono text-on-surface-variant blur-[4px]">{agencyPhone}</p>
                        <p className="text-[10px] text-on-surface-variant blur-[2px]">Kathmandu, Nepal</p>
                      </div>
                      <hr className="w-full border-outline-variant/30 my-1"/>
                      <p className="text-[11px] text-on-surface-variant leading-tight">
                        Sign up and pay a one-time fee of <span className="font-bold text-on-surface">Rs. 500</span> to unlock all agencies.
                      </p>
                  ...
                  <div className="relative bg-surface-container-high rounded-xl p-6 overflow-hidden text-center border border-primary/10">
                    <div className="relative z-20 flex flex-col items-center gap-4">
                      <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center mb-1">
                        <span className="material-symbols-outlined text-primary">payments</span>
                      </div>
                      <h5 className="font-bold text-on-surface uppercase tracking-widest text-[10px]">Unlock Details</h5>
                      <div className="space-y-1 select-none">
                        <p className="text-sm font-mono text-on-surface-variant blur-[4px]">{agencyPhone}</p>
                        <p className="text-[10px] text-on-surface-variant blur-[2px]">Kathmandu, Nepal</p>
                      </div>
                      <hr className="w-full border-outline-variant/30 my-1"/>
                      <p className="text-[11px] text-on-surface-variant leading-tight px-2">
                  ...
                  <div className="space-y-6">
                    <div className="bg-surface-container-lowest rounded-xl p-5 border border-primary/20 shadow-sm">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold text-on-surface">{agencyPhone}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold text-on-surface">{agencyName}</p>
                        </div>
                      </div>
                    </div>
