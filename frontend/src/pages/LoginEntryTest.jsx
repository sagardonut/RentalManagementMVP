...
export default function LoginEntryTest() {
  return (
    <div className="bg-[#FAFBFE] min-h-screen flex flex-col">
      <header className="w-full py-6 px-8 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-screen-xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-3xl text-[#0040A1]">home</span>
            <span className="text-xl font-black text-slate-900 dark:text-white">The Urban Sanctuary</span>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow pt-32 pb-20 px-6 max-w-screen-xl mx-auto w-full">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 font-medium leading-relaxed">Select your role to access the appropriate portal for your needs.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Link to="/signin" className="group">
            <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-100 dark:border-slate-800 shadow-[0_12px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-500 h-full">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3">Member</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-6">Sign in as a resident or property seeker to manage your bookings and explore Kathmandu.</p>
          ...
          <Link to="/agent/signin" className="group">
            <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-100 dark:border-slate-800 shadow-[0_12px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-500 h-full">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3">Property Agent</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-6">Access the Agent Portal to manage your property listings, verify amenities, and assist seekers.</p>
          ...
          <Link to="/signin" className="group">
            <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-100 dark:border-slate-800 shadow-[0_12px_40px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-500 h-full">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3">Agency Admin</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-6">Manage your agency portfolio, oversee agent performance, and access high-level analytics.</p>
