...
export default function AgencyDashboardMinimal() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      {/* Header */}
      <header className="bg-white dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200/50 shadow-sm">
      ...
      {/* Navigation */}
      <nav className="bg-white dark:bg-slate-900/60 backdrop-blur-sm border-b border-gray-200/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {activeTab === 'dashboard' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
        ...
        {activeTab === 'agents' && (
          <div>
            ...
            {agents.length === 0 ? (
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-12 text-center border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {agents.map((agent, index) => (
                  <div key={index} className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
