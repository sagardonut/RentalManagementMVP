    ...
    <div className="bg-surface dark:bg-slate-900 text-on-surface dark:text-slate-100 min-h-screen flex flex-col pt-20">
      ...
      <main className="flex-grow flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-surface dark:bg-slate-800 p-8 rounded-xl shadow-[0_8px_24px_-8px_rgba(25,27,35,0.06)] border border-outline-variant/20">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  required
                  className="w-full px-4 py-3 bg-surface dark:bg-slate-800 border-none rounded-xl focus:ring-2 focus:ring-surface-tint/20 transition-all text-on-surface dark:text-slate-100" 
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className="w-full bg-primary hover:bg-surface dark:bg-slate-900-tint text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary/20 transition-all active:scale-[0.98] disabled:opacity-50"
              >
