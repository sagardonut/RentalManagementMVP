      ...
      <div className="bg-surface dark:bg-slate-800 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
        <div className="p-6 border-b border-surface-container">
          <div className="flex justify-between items-center">
            <div className="h-8 w-48 bg-surface dark:bg-slate-800 rounded animate-pulse"></div>
            <div className="flex gap-2">
              <div className="h-10 w-24 bg-surface dark:bg-slate-800 rounded animate-pulse"></div>
              <div className="h-10 w-24 bg-surface dark:bg-slate-800 rounded animate-pulse"></div>
            </div>
          </div>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-20 w-full bg-surface dark:bg-slate-800 rounded-xl animate-pulse"></div>
            ))}
          </div>
        </div>
      </div>
    ...
    <div className="bg-surface dark:bg-slate-800 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
      ...
      <div className="p-6 border-b border-surface-container">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h2 className="text-xl font-bold text-on-surface dark:text-slate-100">Agencies Management</h2>
            <p className="text-sm text-on-surface dark:text-slate-400">Monitor and manage all platform partners</p>
          </div>
      ...
      <div className="p-6 border-b border-surface-container bg-surface dark:bg-slate-800/30">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-surface dark:bg-slate-900 rounded-xl p-4 border border-outline-variant/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-on-surface dark:text-slate-400 uppercase tracking-wider">Total Agencies</p>
                <p className="text-2xl font-bold text-on-surface dark:text-slate-100 mt-1">{agencies.length}</p>
              </div>
          ...
          <div className="bg-surface dark:bg-slate-900 rounded-xl p-4 border border-outline-variant/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-on-surface dark:text-slate-400 uppercase tracking-wider">Active Agencies</p>
          ...
          <div className="bg-surface dark:bg-slate-900 rounded-xl p-4 border border-outline-variant/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-on-surface dark:text-slate-400 uppercase tracking-wider">Verified Agencies</p>
          ...
          <div className="bg-surface dark:bg-slate-900 rounded-xl p-4 border border-outline-variant/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-bold text-on-surface dark:text-slate-400 uppercase tracking-wider">Avg Performance</p>
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-surface-container">
            {filteredAgencies.length === 0 ? (
              ...
              filteredAgencies.map((agency) => (
                <tr key={agency._id} className="hover:bg-surface dark:bg-slate-800/30 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-on-surface dark:text-slate-100">{agency.fullName}</p>
                        <p className="text-sm text-on-surface dark:text-slate-400">ID: {agency._id.slice(-6)}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div>
                      <p className="text-sm text-on-surface dark:text-slate-100">{agency.email}</p>
                      <p className="text-sm text-on-surface dark:text-slate-400">{agency.phone || 'No phone'}</p>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-xs font-medium text-on-surface dark:text-slate-400">Performance</span>
                  ...
                  <td className="px-6 py-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-lg text-on-surface dark:text-slate-400">badge</span>
                        <span className="text-sm font-medium text-on-surface dark:text-slate-100">{agency.agentCount || 0} Agents</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-lg text-on-surface dark:text-slate-400">bed</span>
                        <span className="text-sm font-medium text-on-surface dark:text-slate-100">{agency.roomCount || 0} Rooms</span>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
