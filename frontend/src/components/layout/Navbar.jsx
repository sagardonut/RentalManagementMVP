...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-white dark:bg-slate-900/80 dark:bg-slate-900/80 backdrop-blur-lg shadow-[0_8px_24px_rgba(25,27,35,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.2)] transition-colors">
      <div className="flex justify-between items-center px-8 py-4 max-w-screen-2xl mx-auto">
        <Link to="/" className="text-xl font-bold tracking-tighter text-blue-900 dark:text-blue-400">
          The Urban Sanctuary
        </Link>
        ...
        <div className="flex items-center space-x-6">
          <button 
            onClick={toggleTheme}
            className="p-2 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors rounded-full hover:bg-slate-100 dark:hover:bg-slate-800"
            title="Toggle Theme"
          >
