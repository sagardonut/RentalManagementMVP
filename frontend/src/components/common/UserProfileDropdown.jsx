  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-3 bg-slate-50 hover:bg-slate-100 px-4 py-2 rounded-xl transition-colors border border-slate-200"
      >
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="text-xs text-slate-500 font-medium capitalize leading-tight">
            {user?.role || 'Guest'}
          </span>
        </div>
        <span className="material-symbols-outlined text-slate-500 text-sm ml-1">
